...
const FiltersFull = () => {
  ...
  const updateURL = debounce((newFilters: FiltersState) => {
    const cleanFiltersData = cleanParams(newFilters);
    const updatedSearchParams = new URLSearchParams();

    Object.entries(cleanFiltersData).forEach(([key, value]) => {
      ...
      <div className='flex flex-col space-y-6'>
        ...
        <div>
          ...
          <div className='flex items-center'>
            ...
            <Button
              ...
              className='rounded-r-xl rounded-l-none border-l-none border shadow-none bg-secondary-500 text-white hover:bg-secondary-600'
            >
        ...
        <div className='flex gap-4 mt-6'>
          ...
          <Button
            ...
            className='flex-1 rounded-xl bg-secondary-500 text-white hover:bg-secondary-600'
          >
            APPLY
          </Button>
